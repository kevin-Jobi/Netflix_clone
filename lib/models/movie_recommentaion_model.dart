  ...
  factory MovieRecommendationModel.fromJson(Map<String, dynamic> json) =>
      MovieRecommendationModel(
        ...
        results: (json["results"] != null)
            ...
            : [], // Provide an empty list if results is null
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        genreIds: json["genre_ids"] != null
            ...
            : [], // Provide empty list if genre_ids is null
        id: json["id"] ?? 0,
        originCountry: json["origin_country"] != null
            ? List<String>.from(json["origin_country"].map((x) => x))
            : [], // Provide empty list if origin_country is null
        originalLanguage: json["original_language"] ?? '',
        originalName: json["original_name"] ?? '',
        overview: json["overview"] ?? '',
        ...
        firstAirDate: json["first_air_date"] != null
            ...
            : null, // Handle null or invalid date format
        name: json["name"] ?? '',
